          ...
          {articoli.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {articoli.map((a) => (
                <article
                  key={a.id}
                  className="bg-white rounded-xl shadow-sm border border-navy/10 hover:shadow-md hover:border-steel/30 transition-all duration-200 flex flex-col overflow-hidden"
                >
